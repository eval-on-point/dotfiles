# Generated by Powerlevel10k configuration wizard on 2020-02-27 at 10:39 EST.
...
() {
  ...
  # Example of a user-defined prompt segment. Function prompt_vterm_tracker will be called on every
  # prompt if `example` prompt segment is added to POWERLEVEL9K_LEFT_PROMPT_ELEMENTS or
  # POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS. It displays an icon and yellow text on red background
  # greeting the user.
  #
  # Type `p10k help segment` for documentation and a more sophisticated example.
  function prompt_vterm_tracker() {
  ...
  function instant_prompt_vterm_tracker() {
      # Since prompt_vterm_tracker always makes the same `p10k segment` calls, we can call it from
      # instant_prompt_vterm_tracker. This will give us the same `example` prompt segment in the instant
      # and regular prompts.
      prompt_vterm_tracker
  }
